        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Project Expense Log</h3>
                </div>
            </div>
            <!-- ============================================================== -->
                            ...
                            <div class="card-body">
                              <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $exp->teid ;?></td>
                                            <td><?php echo $exp->tcid ;?></td>
                                            <td><?php echo $exp->pcode ;?></td>
                                            <td><?php echo $exp->expense_date ;?></td>
                                            <td><?php echo $exp->expense_amount ;?></td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
                                </table>
